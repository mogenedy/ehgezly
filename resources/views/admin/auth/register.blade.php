                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    <div class="mb-3 text-center">
                                        <img src="{{ asset('/admin/assets/images/ehgezly.jpg') }}" width="100"
                                            alt="" />
                                    </div>
                                        ...
                                        <form class="row g-3" method="POST" action="{{ route('admin.register') }}">
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    id="inputUsername" placeholder="من فضلك ادخل اسمك">
                                            </div>
                                            <div class="col-12">
											...
											{{-- <div class="col-12">
												<label for="inputChooseRole" class="form-label">Choose role</label>
												<div class="input-group">
													<select name="role_id" class="form-control border-end-0" id="inputChooseRole" required>
