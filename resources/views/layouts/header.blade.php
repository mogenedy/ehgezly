        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    <img src="{{ asset('admin/assets/images/avatars/avatar-2.png') }}" class="user-img rounded-circle"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item d-flex align-items-center" href="javascript:;"><i
                                class="bx bx-user fs-5"></i><span>الملف الشخصي</span></a></li>
                    <li><a class="dropdown-item d-flex align-items-center" href="javascript:;"><i
                                class="bx bx-home-circle fs-5"></i><span>الصفحة الرئيسية</span></a></li>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:;"
                            ...
                            <i class="bx bx-log-out-circle fs-5"></i><span>تسجيل الخروج</span>
                        </a>
                    </li>
                </ul>
